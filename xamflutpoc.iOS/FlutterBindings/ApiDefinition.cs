...
*/
	...
	// could be [BlockCallback] instead of [CCallback]
	...
	//[Static]
	// DONTKNOW?? [Verify (ConstantsInterfaceAssociation)]
...
*/
	...
	/* error BI1014: bgen: Unsupported type for Fields: NSObject for 'Flutter.Constants FlutterEndOfEventStream'.
	 */
	partial interface Constants
	{
...
*/[Protocol]
  ...
  be used.
*/[Protocol]
	interface IFlutterAppLifeCycleProvider : IUNUserNotificationCenterDelegate
	{
	...
	interface FlutterAppDelegate : IUIApplicationDelegate, FlutterPluginRegistry, IFlutterAppLifeCycleProvider
	{
